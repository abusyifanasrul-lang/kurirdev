-- Fix complete_order: add timezone-aware date validation for fines
-- Perubahan: 
-- 1. Add v_timezone and v_today variables
-- 2. Fine deduction now checks shift_attendance for 'per_order' fine_type on the correct date
