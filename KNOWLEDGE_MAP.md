...
## Session Update: 2026-05-28 15:17:03
- **Type**: auto_harvest
- **Desc**: Changes in 1 file(s): . Functions: . 1 chunk(s) unclassified.
- **Files**: `supabase/migrations/20260511170100_fix_basecamps_rls_include_admin_role.sql`
- **Confidence**: 0.3
- **Method**: heuristic
---
- **Type**: auto_harvest
...
---
- **Type**: devops
- **Desc**: Update GitHub backup workflow configuration
...
---
- **Type**: bugfix
- **Desc**: Fix user store state management logic
...
---
- **Type**: bugfix
- **Desc**: Migration: Fix record_courier_checkin RPC
...
---
- **Type**: refactor
- **Desc**: Migration: Dump queue-related functions
...
## Session Update: 2026-05-28 15:08:51
- **Type**: auto_harvest
- **Desc**: Changes in 1 file(s): . Functions: . 1 chunk(s) unclassified.
- **Files**: `supabase/migrations/20260511170100_fix_basecamps_rls_include_admin_role.sql`
- **Confidence**: 0.3
...
## Session Update: 2026-05-28 14:47:51
- **Type**: auto_harvest
- **Desc**: Changes in 1 file(s): . Functions: . 1 chunk(s) unclassified.
- **Files**: `supabase/migrations/20260511170100_fix_basecamps_rls_include_admin_role.sql`
- **Confidence**: 0.3
...
## Session Update: 2026-05-28 14:28:24
- **Type**: auto_harvest
- **Desc**: Changes in 1 file(s): . Functions: . 1 chunk(s) unclassified.
- **Files**: `supabase/migrations/20260511170100_fix_basecamps_rls_include_admin_role.sql`
- **Confidence**: 0.3
...
## Session Update: 2026-05-27 20:03:25
- **Type**: auto_harvest
- **Desc**: Changes in 1 file(s): . Functions: . 1 chunk(s) unclassified.
- **Files**: `supabase/migrations/20260511170100_fix_basecamps_rls_include_admin_role.sql`
- **Confidence**: 0.3
...
## Session Update: 2026-05-09 12:26:23
- **Type**: devops
- **Desc**: Update GitHub backup workflow configuration
- **Files**: `.github/workflows/backup.yml`
- **Confidence**: 0.9
...
## Session Update: 2026-05-09 03:42:07
- **Type**: devops
- **Desc**: Update GitHub backup workflow configuration
- **Files**: `.github/workflows/backup.yml`
- **Confidence**: 0.9
...
## Session Update: 2026-05-08 22:04:07
- **Type**: devops
- **Desc**: Update GitHub backup workflow configuration
- **Files**: `.github/workflows/backup.yml`
- **Confidence**: 0.9
...
## Session Update: 2026-05-08 21:53:20
- **Type**: auto_harvest
- **Desc**: Changes in 1 file(s): . Functions: . 1 chunk(s) unclassified.
- **Files**: `.github/workflows/backup.yml`
- **Confidence**: 0.3
...
## Session Update: 2026-05-05 12:54:45
- **Type**: auto_harvest
- **Desc**: Changes in 1 file(s): . Functions: . 1 chunk(s) unclassified.
- **Files**: `.github/workflows/backup.yml`
- **Confidence**: 0.3
...
## Session Update: 2026-05-05 01:16:37
- **Type**: auto_harvest
- **Desc**: Changes in 1 file(s): . Functions: . 1 chunk(s) unclassified.
- **Files**: `.github/workflows/backup.yml`
- **Confidence**: 0.3
...
## Session Update: 2026-05-04 22:45:24
- **Type**: auto_harvest
- **Desc**: Changes in 1 file(s): . Functions: . 1 chunk(s) unclassified.
- **Files**: `.github/workflows/backup.yml`
- **Confidence**: 0.3
...
## Session Update: 2026-05-04 09:54:41
- **Type**: auto_harvest
- **Desc**: Changes in 3 file(s): 1 added. Functions: getTier. 2 chunk(s) unclassified.
- **Files**: `src/pages/Dashboard.tsx, src/pages/courier/CourierDashboard.tsx, src/stores/useUserStore.ts`
- **Overwrites**: `getTier`
...
## Session Update: 2026-05-04 03:47:59
- **Type**: auto_harvest
- **Desc**: Changes in 3 file(s): 1 added. Functions: getTier. 2 chunk(s) unclassified.
- **Files**: `src/pages/Dashboard.tsx, src/pages/courier/CourierDashboard.tsx, src/stores/useUserStore.ts`
- **Overwrites**: `getTier`
...
## Session Update: 2026-05-03 18:11:09
- **Type**: auto_harvest
- **Desc**: Changes in 3 file(s): 1 added. Functions: getTier. 2 chunk(s) unclassified.
- **Files**: `src/pages/Dashboard.tsx, src/pages/courier/CourierDashboard.tsx, src/stores/useUserStore.ts`
- **Overwrites**: `getTier`
...
## Session Update: 2026-05-03 09:49:21
- **Type**: auto_harvest
- **Desc**: Changes in 3 file(s): 1 added. Functions: getTier. 2 chunk(s) unclassified.
- **Files**: `src/pages/Dashboard.tsx, src/pages/courier/CourierDashboard.tsx, src/stores/useUserStore.ts`
- **Overwrites**: `getTier`
...
## Session Update: 2026-05-01 08:07:18
- **Type**: auto_harvest
- **Desc**: Changes in 3 file(s): 1 added. Functions: getTier. 2 chunk(s) unclassified.
- **Files**: `src/pages/Dashboard.tsx, src/pages/courier/CourierDashboard.tsx, src/stores/useUserStore.ts`
- **Overwrites**: `getTier`
...
## Session Update: 2026-04-30 19:31:07
- **Type**: auto_harvest
- **Desc**: Changes in 9 file(s): 1 added. Functions: invoke_process_alpha. 8 chunk(s) unclassified.
- **Files**: `src/stores/useAdminAttendanceStore.ts, supabase/config.toml, supabase/functions/process-alpha/deno.json, supabase/functions/process-alpha/index.ts, supabase/migrations/20260429_cron_process_alpha.sql, supabase/migrations/20260429_fix_complete_order_fine_validation.sql, supabase/migrations/20260429_fix_get_missing_couriers.sql, supabase/migrations/20260429_fix_process_shift_alpha.sql, supabase/migrations/20260429_fix_record_courier_checkin.sql`
- **Overwrites**: `invoke_process_alpha`
